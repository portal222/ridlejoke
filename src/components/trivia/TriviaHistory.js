...
const Trivia = (props) => {
    ...
    const getAnswer = async () => {
        ...
        const url2 = `https://api.api-ninjas.com/v1/trivia?category=historyholidays`;
        const url3 = `https://api.api-ninjas.com/v1/trivia?category=historyholidays`;
    ...
    return (
        <>
            <div className="trivia" >
                <div className="categ">History & Holidays</div>
