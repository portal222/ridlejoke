...
const Trivia = () => {
    ...
    const getAnswer = async () => {
        ...
        const url2 = `https://api.api-ninjas.com/v1/trivia?category=sportsleisure`;
        const url3 = `https://api.api-ninjas.com/v1/trivia?category=sportsleisure`;
    ...
    return (
        <>
            <div className="trivia" >
                <div className="categ">Sports & Leisure</div>
