...
const Trivia = (props) => {
    ...
    const getAnswer = async () => {
        const url = `https://api.api-ninjas.com/v1/trivia?category=sciencenature`;
        const url2 = `https://api.api-ninjas.com/v1/trivia?category=sciencenature`;
        const url3 = `https://api.api-ninjas.com/v1/trivia?category=sciencenature`;
    ...
    return (
        <>
            <div className="trivia" >
                <div className="categ">Science & Nature</div>
