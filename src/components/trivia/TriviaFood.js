...
const Trivia = (props) => {
    ...
    const getAnswer = async () => {
        const url = `https://api.api-ninjas.com/v1/trivia?category=fooddrink`;
        const url2 = `https://api.api-ninjas.com/v1/trivia?category=fooddrink`;
        const url3 = `https://api.api-ninjas.com/v1/trivia?category=fooddrink`;
    ...
    return (
        <>
            <div className="trivia" >
                <div className="categ">Food & Drink</div>
