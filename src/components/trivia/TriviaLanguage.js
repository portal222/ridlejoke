...
const Trivia = (props) => {
    ...
    const getAnswer = async () => {
        ...
        const url2 = `https://api.api-ninjas.com/v1/trivia?category=language`;
        const url3 = `https://api.api-ninjas.com/v1/trivia?category=language`;
    ...
    return (
        <>
            <div className="trivia" >
                <div className="categ">Language</div>
