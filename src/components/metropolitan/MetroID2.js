...
const MetroID2 = (props) => {
    ...
    const getCity = async () => {
        const url = `https://collectionapi.metmuseum.org/public/collection/v1/objects/${props.metropolitan2}`;
    ...
    const handleClick = (linkName) => {
        const LinkTo = `/linkMetro/${linkName}`;
        navigate(LinkTo);
    }
